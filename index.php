			...
			<div id="header-wrapper">
				<div id="header" class="container">
					...
					<nav id="nav">
						<ul>
							...
							<li class="break"><a href="panduan.php">PANDUAN</a></li>
				...
				<section id="hero" class="container">
					...
					<p>Designed and built on <strong>skel</strong> by <a href="http://twitter.com/ajlkn">AJ</a>. Released for free under
						<br /> the <a href="http://html5up.net/license">Creative Commons Attribution 3.0 license</a>.</p>
					<ul class="actions">
						<li><a href="#" class="button">Daftarkan Tim Saya!</a></li>
					</ul>
				</section>
